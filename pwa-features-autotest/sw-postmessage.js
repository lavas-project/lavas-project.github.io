    ...
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(event) {
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        (0, _log.log)('Message event');

                        _context.next = 3;
                        return _store.featureStore.setItem('sw-msg-got', 1);

                    case 3:
                        (0, _log.log)('- sw-msg-got done -', 1);
                        ...
                        _context.next = 8;
                        return _store.featureStore.setItem('sw-msg-send', 1);

                    case 8:
                        (0, _log.log)('- sw-msg-send done -', ' by event.source -', 1);
                    ...
                    case 10:
                        ...
                        _context.next = 14;
                        return _store.featureStore.setItem('sw-msg-send', 0.8);

                    case 14:
                        (0, _log.log)('- sw-msg-send done -', ' by clients -', 0.8);
                    ...
                    case 16:
                        ...
                        _context.next = 20;
                        return _store.featureStore.setItem('sw-msg-send', 0.5);

                    case 20:
                        (0, _log.log)('- sw-msg-send done -', ' by ch.port -', 0.5);
                        // await store.put('feature', 'event.data.port', 'sw-msg-send-by')
                        return _context.abrupt('return');

                    case 22:
                        _context.next = 24;
                        return _store.featureStore.setItem('sw-msg-send', 0);

                    case 24:
                        (0, _log.log)('- sw-msg-send done -', ' no -', 0);
