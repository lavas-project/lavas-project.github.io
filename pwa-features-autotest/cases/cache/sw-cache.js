...
self.addEventListener('install', function (event) {
    ...
    if (self.Cache) {
        _store.featureStore.setItem('Cache', 1);
    }
    ...
    var baseUrl = "/pwa-features-autotest" + '/cache/';

    /* eslint-disable fecs-max-statements */
    event.waitUntil((0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
        var value, cache1, hasCaches1, hasCachesKeys, cachesKeys, cachesKeysCheck, hasCheck, hasCaches2, urlPut, resPut, matchCache, matchCacheData, matchCaches, matchCachesData, urlAddAll, cacheKeys, urlAdd, matchAllCache;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        ...
                        _context2.next = 3;
                        return caches.open('caches-1');

                    case 3:
                        cache1 = _context2.sent;
                        _context2.next = 6;
                        return caches.has('caches-1');

                    case 6:
                        hasCaches1 = _context2.sent;

                        value = Number(hasCaches1);
                        _context2.next = 10;
                        return _store.featureStore.setItem('caches.open', value);

                    case 10:
                        _context2.next = 12;
                        return _store.featureStore.setItem('caches.has', value);

                    case 12:
                        (0, _log.log)('- caches open/has done -', value);

                        // caches.keys
                        _context2.next = 15;
                        return caches.open('caches-2');
                    ...
                    case 17:
                        hasCachesKeys = _context2.sent;

                        value = Number(hasCachesKeys && hasCachesKeys.length >= 2);
                        _context2.next = 21;
                        return _store.featureStore.setItem('caches.keys', value);

                    case 21:
                        (0, _log.log)('- caches keys done -', value, hasCachesKeys);

                        // caches.delete (** 猎豹 caches.delete().then() no response **)
                        // await caches.delete('caches-2');
                        caches.delete('caches-2').then(function () {
                                    ...
                                    while (1) {
                                        switch (_context.prev = _context.next) {
                                            ...
                                            case 2:
                                                ...
                                                value = Number(res);
                                                _context.next = 7;
                                                return _store.featureStore.setItem('caches.delete', value);
                    ...
                    case 27:
                        cachesKeys = _context2.sent;

                        (0, _log.log)('- caches keys done -', cachesKeys);
                        cachesKeysCheck = cachesKeys.length >= hasCachesKeys.length;
                        _context2.next = 32;
                        return caches.has('caches-2');

                    case 32:
                        hasCheck = _context2.sent;
                        hasCaches2 = cachesKeysCheck && hasCheck;
                    ...
                    case 48:
                        matchCache = _context2.sent;
                        _context2.next = 51;
                        return matchCache.json();

                    case 51:
                        matchCacheData = _context2.sent;
                    ...
                    case 62:
                        matchCaches = _context2.sent;
                        _context2.next = 65;
                        return matchCaches.json();

                    case 65:
                        matchCachesData = _context2.sent;
                    ...
                    case 74:
                        ...
                        (0, _log.log)('caches.match error', _context2.t0);
