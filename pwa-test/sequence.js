...
var _localforage = __webpack_require__(109);
                                    ...
                                    while (1) {
                                        switch (_context3.prev = _context3.next) {
                                            case 0:
                                                ...
                                                _context3.next = _context3.t0 === 'string' ? 4 : _context3.t0 === 'undefined' ? 8 : _context3.t0 === 'object' ? 12 : 14;
                                                break;
            ...
            while (1) {
                switch (_context11.prev = _context11.next) {
                    case 0:
                        ...
                        _context11.next = 8;
                        return _promise2.default.all([_store.uaStore.setItem('browser', (0, _stringify2.default)(browser)), _store.uaStore.setItem('os', (0, _stringify2.default)(os)), _store.uaStore.setItem('device', (0, _stringify2.default)(device)), _store.uaStore.setItem('ua', ua)]);
...
var _uaParserJs = __webpack_require__(110);
...
var Symbol = __webpack_require__(113).Symbol;
var USE_SYMBOL = typeof Symbol == 'function';
...
if (__webpack_require__(118)) {
  ...
  var $buffer = __webpack_require__(242);
  var ctx = __webpack_require__(132);
...
var isObject = __webpack_require__(115);
var has = __webpack_require__(124);
var setDesc = __webpack_require__(119).f;
var id = 0;
var isExtensible = Object.isExtensible || function () {
  return true;
};
...
var ArrayProto = Array.prototype;
if (ArrayProto[UNSCOPABLES] == undefined) __webpack_require__(125)(ArrayProto, UNSCOPABLES, {});
module.exports = function (key) {
...
var defined = __webpack_require__(137);
var fails = __webpack_require__(114);
var spaces = __webpack_require__(223);
var space = '[' + spaces + ']';
var non = '\u200b\u0085';
...
module.exports = __webpack_require__(148) || !__webpack_require__(114)(function () {
  var K = Math.random();
  // In FF throws only define methods
  // eslint-disable-next-line no-undef, no-useless-call
  __defineSetter__.call(null, K, function () { /* empty */ });
  delete __webpack_require__(113)[K];
});
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        _context3.next = 2;
                        return _store.uuidStore.getItem('id');
                    ...
                    case 2:
                        ...
                        id = (0, _helper.uuid)();
                        _context3.next = 7;
                        return _store.uuidStore.setItem('id', id);
...
var _featureList = __webpack_require__(208);
...
var totalScore = document.querySelector('.score-wrapper .total-score');
var totalSchedule = document.querySelector('.score-wrapper .title span');
var sendDataBtn = document.querySelector('.send-data');

window.result = function (caseName) {
    var list = _featureList.featureKeys[caseName.toLowerCase()];
    var caseIdShow = '.schedule #' + caseName.toLowerCase() + '-show';
    var casePart = document.querySelector(caseIdShow);
...
function initFeatureScore() {
    var tbody = [];
    var schedule = [];
    for (var key in _featureList.featureKeys) {
        var mid = _featureList.featureKeys[key].map(function (item) {
            summary.feature[item] = 0;
            return ['<tr id="' + item.toLowerCase().replace(/\./g, '-') + '">', '<td class="name">' + item + '</td>', '<td class="score">' + 0 + '</td>', '</tr>'].join('');
        });

        schedule = schedule.concat(['<div id="' + key + '-show" class="case-part">', '<div class="case-name">' + key + '</div>',
        // '<div class="case-schedule"></div>',
        '</div>']);
        totalTestNum += _featureList.featureKeys[key].length;
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return _store.featureStore.getItem(item);
                        ...
                        case 2:
                            ...
                            idClass = '#' + item.toLowerCase().replace(/\./g, '-') + ' .score';
...
function uaProcess() {
    ...
    (0, _helper.uaParse)();
    _featureList.uaKeys.forEach(function () {
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.next = 2;
                            return _store.uaStore.getItem(item);
...
function sendDataBtnBind() {
    ...
    sendDataBtn.addEventListener('click', function () {
        var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(e) {
            var sendDataConfirm, res, sendTip;
            return _regenerator2.default.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
...
var featureKeys = exports.featureKeys = {
    lifecycle: ['lifecycle', 'navigator.serviceWorker', 'navigator.serviceWorker.ready', 'oncontrollerchange',
    // 'onstatechange',
    'Registered', 'Unregistered', 'clients.claim', 'self.skipWaiting', 'installEvent', 'activateEvent', 'installEvent.waitUntil', 'activateEvent.waitUntil'],
    fetch: ['Promise', 'fetch', 'Request', 'Response',
    // 'Headers',
    'fetchEvent', 'fetchEvent.request', 'fetchEvent.respondWith'],
    indexeddb: ['indexedDB', 'indexedDB.getAll'],
    cache: ['Cache', 'caches', 'caches.open', 'caches.has',
    // 'caches.keys',
    // 'caches.match',
    'caches.delete', 'cache.add', 'cache.addAll', 'cache.delete', 'cache.keys', 'cache.match',
    // 'cache.matchAll',
    'cache.put'],
    sync: ['syncEvent'],
    ...
    push: ['pushManager.subscribe', 'pushManager.getSubscription', 'pushManager.permissionState', 'pushSubscription.unsubscribe']
};
...
exports.default = function (scope) {
    return {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 20:
                                ...
                                _context.next = 25;
                                return _promise2.default.all([(0, _helper.grade)('fetch', 1), (0, _helper.grade)('Response', 1)]);
        ...
        error: function error(e) {
            (0, _log.log)('fetch: catch unhandled error');
...
exports.default = function (scope) {
    return {
        ...
        error: function error(e) {
            (0, _log.log)('sync: catch unhandled error');
            (0, _log.log)(e);
        }
    };
};
    ...
    return {
        ...
        main: function main() {
            ...
            return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
                var reg, result, scores, lifecycleScore;
                return _regenerator2.default.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return (0, _helper.zero)(CHECK_LIST);
                            ...
                            case 10:
                                ...
                                navigator.serviceWorker.addEventListener('controllerchange', function (e) {
                                    (0, _helper.grade)('clients.claim', 1);
                            ...
                            case 15:
                                ...
                                (0, _log.log)('lifecycle: sw-1.js registered', reg);
                                _context2.next = 20;
                                return (0, _helper.grade)('Registered', 1);

                            case 20:

                                (0, _log.log)('lifecycle: sleep for 3s');
                                _context2.next = 23;
                                return (0, _helper.sleep)(3000);

                            case 23:

                                (0, _log.log)('lifecycle: unregister sw-lifecycle.js');
                                _context2.next = 26;
                                return reg.unregister();
                            ...
                            case 30:
                                _context2.next = 32;
                                return _promise2.default.all(CHECK_LIST.map(function (feature) {
        ...
        error: function error(e) {
            (0, _log.log)('lifecycle: catch unhandled error');
            (0, _log.log)(e);
        }
    };
};
 ...
 * @author ruoran (liuruoran@baidu.com)
 */
var CHECK_LIST = ['lifecycle', 'navigator.serviceWorker', 'navigator.serviceWorker.ready', 'oncontrollerchange', 'onstatechange', 'onupdatefound', 'Registered', 'Unregistered', 'clients.claim', 'self.skipWaiting', 'installEvent', 'activateEvent', 'installEvent.waitUntil', 'activateEvent.waitUntil'];
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 3:
                                ...
                                (0, _log.log)('sw-cache register');
                                _context.next = 6;
                                return navigator.serviceWorker.register(scope + 'sw-cache.js', { scope: scope });
...
var CHECK_LIST = ['Cache', 'caches', 'caches.open', 'caches.has', 'caches.keys', 'caches.match', 'caches.delete', 'cache.add', 'cache.addAll', 'cache.delete', 'cache.keys', 'cache.match', 'cache.matchAll', // no statistics
'cache.put'];
...
exports.default = function (scope) {
    return {
        ...
        main: function main() {
            ...
            return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                var reg, hasNotification;
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:

                                (0, _log.log)('<< notification-test >>');
                            ...
                            case 3:
                                _context.next = 5;
                                return navigator.serviceWorker.register(scope + 'sw-notification.js', { scope: scope });
                            ...
                            case 8:
                                ...
                                _context.next = 11;
                                return _store.featureStore.setItem('Notification', 1);

                            case 11:
                                (0, _log.log)('- notification done -', 1);

                            case 12:
                                _context.next = 14;
                                return reg.showNotification('Hello World!');

                            case 14:
                                _context.next = 16;
                                return _store.featureStore.setItem('showNotification', 1);

                            case 16:
                                (0, _log.log)('- showNotification done -', 1);
                            ...
                            case 19:
                                hasNotification = _context.sent;
                                _context.next = 22;
                                return _store.featureStore.setItem('getNotification', 1);

                            case 22:
                                (0, _log.log)('- getNotifications done -', 1, hasNotification);
                            ...
                            case 27:
                                (0, _log.log)('notification: test finish');
...
var CHECK_LIST = ['notification',
// 'notification.requestPermission',
'showNotification', 'getNotification', 'notificationclick' // no statistics
];
...
exports.default = function (scope) {
    return {
        ...
        main: function main() {
            ...
            return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                var reg, pushManager, permissionState, subscribe, getSubscribe;
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:

                                (0, _log.log)('<< push-test >>');
                                ...
                                (0, _log.log)('no applicationServerKey or no sw');
                                return _context.abrupt('return');

                            case 4:
                                _context.next = 6;
                                return navigator.serviceWorker.register(scope + 'sw-push.js', { scope: scope });
                            ...
                            case 9:
                                ...
                                (0, _log.log)('no pushManager', pushManager);
                                _context.next = 15;
                                return reg.unregister();

                            case 15:
                                (0, _log.log)('push: test finish');
                                return _context.abrupt('return');

                            case 17:
                                _context.next = 19;
                                return _store.featureStore.setItem('pushManager', 1);

                            case 19:
                                (0, _log.log)('- pushManager done -', 1, pushManager);
                            ...
                            case 23:
                                ...
                                _context.next = 26;
                                return _store.featureStore.setItem('pushManager.permissionState', 1);

                            case 26:
                                (0, _log.log)('- pushManager.permissionState done -', 1);
                            ...
                            case 34:
                                ...
                                (0, _log.log)('Failed to test permissionState: ', _context.t0);
                            ...
                            case 44:
                                ...
                                (0, _log.log)('Failed to subscribe the user: ', _context.t1);
                            ...
                            case 51:
                                getSubscribe = _context.sent;
                                _context.next = 54;
                                return _store.featureStore.setItem('pushManager.getSubscription', 1);
                            ...
                            case 54:
                                ...
                                _context.next = 58;
                                return _store.featureStore.setItem('pushManager.subscribe', 1);
                            ...
                            case 61:
                                ...
                                (0, _log.log)('Failed to test getSubscription: ', _context.t2);
                            ...
                            case 69:
                                ...
                                _context.next = 73;
                                return _store.featureStore.setItem('pushSubscription.unsubscribe', 1);

                            case 73:
                                (0, _log.log)('- pushSubscription.unsubscribe done -', Number(!getSubscribe));

                            case 74:

                                (0, _log.log)('sleep for 5s');
                                _context.next = 77;
                                return (0, _helper.sleep)(5000);

                            case 77:
                                (0, _log.log)('unregister sw-push.js');
                                _context.next = 80;
                                return reg.unregister();
                ...
                }, _callee, _this, [[20, 34], [38, 44], [48, 61]]);
            }))();
        }
    };
};
 ...
 * @author ruoran (liuruoran@baidu.com)
 */
var CHECK_LIST = ['pushManager', // no statistics
'pushManager.permissionState', 'pushManager.getSubscription', 'pushManager.subscribe', 'pushSubscription.unsubscribe', 'pushEvent' // no statistics
];
...
var isObject = __webpack_require__(115);
var document = __webpack_require__(113).document;
// typeof document.createElement is 'object' in old IE
var is = isObject(document) && isObject(document.createElement);
module.exports = function (it) {
  return is ? document.createElement(it) : {};
...
var defineProperty = __webpack_require__(119).f;
module.exports = function (name) {
  var $Symbol = core.Symbol || (core.Symbol = LIBRARY ? {} : global.Symbol || {});
  if (name.charAt(0) != '_' && !(name in $Symbol)) defineProperty($Symbol, name, { value: wksExt.f(name) });
};
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(132)(Function.call, __webpack_require__(130).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(125)(IteratorPrototype, __webpack_require__(117)('iterator'), function () { return this; });
...
var cel = __webpack_require__(217);
var global = __webpack_require__(113);
var process = global.process;
var setTask = global.setImmediate;
var clearTask = global.clearImmediate;
...
module.exports = !__webpack_require__(118) && !__webpack_require__(114)(function () {
...
var ws = __webpack_require__(223);
var hex = /^[-+]?0[xX]/;
...
// 21.2.5.3 get RegExp.prototype.flags()
if (__webpack_require__(118) && /./g.flags != 'g') __webpack_require__(119).f(RegExp.prototype, 'flags', {
  configurable: true,
...
var gOPS = __webpack_require__(174);
var anObject = __webpack_require__(112);
var Reflect = __webpack_require__(113).Reflect;
...
var toLength = __webpack_require__(120);
var repeat = __webpack_require__(225);
var defined = __webpack_require__(137);
...
var getKeys = __webpack_require__(149);
var toIObject = __webpack_require__(129);
var isEnum = __webpack_require__(167).f;
    ...
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
        ...
        return _regenerator2.default.wrap(function _callee3$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        step = (0, _helper.createStep)('main');
                        _context4.next = 3;
                        return step(_helper.init, false);

                    case 3:

                        (0, _common.refreshCommon)();

                        _context4.next = 6;
                        return step((0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                            var features;
                            return _regenerator2.default.wrap(function _callee$(_context) {
                                while (1) {
                                    switch (_context.prev = _context.next) {
                            ...
                            return _regenerator2.default.wrap(function _loop$(_context3) {
                                while (1) {
                                    switch (_context3.prev = _context3.next) {
                                        case 0:
                                            _context3.next = 2;
                                            return step((0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
                                                return _regenerator2.default.wrap(function _callee2$(_context2) {
                                                    while (1) {
                                                        switch (_context2.prev = _context2.next) {
                                                            case 0:
                                        ...
                                        case 2:
                                            ...
                                            window.result(_demos2.default[i].name);
...
var _demos = __webpack_require__(289);
...
var _sequence = __webpack_require__(290);

var _sequence2 = _interopRequireDefault(_sequence);

var _sequence3 = __webpack_require__(291);

var _sequence4 = _interopRequireDefault(_sequence3);

var _sequence5 = __webpack_require__(292);

var _sequence6 = _interopRequireDefault(_sequence5);

var _sequence7 = __webpack_require__(293);

var _sequence8 = _interopRequireDefault(_sequence7);

var _sequence9 = __webpack_require__(294);

var _sequence10 = _interopRequireDefault(_sequence9);

var _sequence11 = __webpack_require__(295);

var _sequence12 = _interopRequireDefault(_sequence11);

var _sequence13 = __webpack_require__(296);

var _sequence14 = _interopRequireDefault(_sequence13);

var _sequence15 = __webpack_require__(297);

var _sequence16 = _interopRequireDefault(_sequence15);
...
exports.default = [_sequence6.default,
// getregistrationCase,
_sequence2.default, _sequence10.default, _sequence8.default, _sequence4.default, _sequence14.default, _sequence12.default, _sequence16.default]; // ok
// 数据统计1个s读取null，getAll
// 数据统计2个读取null onstatechange+activate.eventUtil
// ok
...
var _demo = __webpack_require__(209);
...
var _demo = __webpack_require__(210);
...
var _demo = __webpack_require__(211);
...
var _demo = __webpack_require__(213);
...
var _demo = __webpack_require__(214);
...
var _demo = __webpack_require__(216);
...
// 19.4.3.4 Symbol.prototype[@@toPrimitive](hint)
$Symbol[PROTOTYPE][TO_PRIMITIVE] || __webpack_require__(125)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
// 19.4.3.5 Symbol.prototype[@@toStringTag]
setToStringTag($Symbol, 'Symbol');
// 20.2.1.9 Math[@@toStringTag]
setToStringTag(Math, 'Math', true);
...
$export($export.S + $export.F * !__webpack_require__(118), 'Object', { defineProperty: __webpack_require__(119).f });
...
$export($export.S + $export.F * !__webpack_require__(118), 'Object', { defineProperties: __webpack_require__(256) });
...
__webpack_require__(139)('getOwnPropertyNames', function () {
  return __webpack_require__(257).f;
});
...
var BROKEN_COF = cof(__webpack_require__(151)(proto)) == NUMBER;
...
var $export = __webpack_require__(21);
var _isFinite = __webpack_require__(113).isFinite;
...
__webpack_require__(127)('anchor', function (createHTML) {
...
__webpack_require__(127)('big', function (createHTML) {
  return function big() {
...
__webpack_require__(127)('blink', function (createHTML) {
...
__webpack_require__(127)('bold', function (createHTML) {
...
__webpack_require__(127)('fixed', function (createHTML) {
...
__webpack_require__(127)('fontcolor', function (createHTML) {
...
__webpack_require__(127)('fontsize', function (createHTML) {
...
__webpack_require__(127)('italics', function (createHTML) {
...
__webpack_require__(127)('link', function (createHTML) {
...
__webpack_require__(127)('small', function (createHTML) {
...
__webpack_require__(127)('strike', function (createHTML) {
...
__webpack_require__(127)('sub', function (createHTML) {
  return function sub() {
...
__webpack_require__(127)('sup', function (createHTML) {
  return function sup() {
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(125)(proto, TO_PRIMITIVE, __webpack_require__(382));
...
$export($export.P + $export.F * (__webpack_require__(166) != Object || !__webpack_require__(134)(arrayJoin)), 'Array', {
...
var $export = __webpack_require__(21);
var $forEach = __webpack_require__(140)(0);
var STRICT = __webpack_require__(134)([].forEach, true);
...
var $export = __webpack_require__(21);
var $map = __webpack_require__(140)(1);

$export($export.P + $export.F * !__webpack_require__(134)([].map, true), 'Array', {
...
var $export = __webpack_require__(21);
var $filter = __webpack_require__(140)(2);

$export($export.P + $export.F * !__webpack_require__(134)([].filter, true), 'Array', {
...
var $export = __webpack_require__(21);
var $some = __webpack_require__(140)(3);

$export($export.P + $export.F * !__webpack_require__(134)([].some, true), 'Array', {
...
var $export = __webpack_require__(21);
var $every = __webpack_require__(140)(4);

$export($export.P + $export.F * !__webpack_require__(134)([].every, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(134)([].reduce, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(134)([].reduceRight, true), 'Array', {
...
$export($export.P + $export.F * (NEGATIVE_ZERO || !__webpack_require__(134)($native)), 'Array', {
...
var $export = __webpack_require__(21);
var $find = __webpack_require__(140)(5);
var KEY = 'find';
var forced = true;
...
var $export = __webpack_require__(21);
var $find = __webpack_require__(140)(6);
var KEY = 'findIndex';
var forced = true;
// Shouldn't skip holes
if (KEY in []) Array(1)[KEY](function () { forced = false; });
...
if (__webpack_require__(118) && (!CORRECT_NEW || __webpack_require__(114)(function () {
...
__webpack_require__(153)('RegExp');
...
var toLength = __webpack_require__(120);
var isObject = __webpack_require__(115);
var ArrayBuffer = __webpack_require__(113).ArrayBuffer;
var speciesConstructor = __webpack_require__(180);
var $ArrayBuffer = buffer.ArrayBuffer;
var $DataView = buffer.DataView;
...
__webpack_require__(153)(ARRAY_BUFFER);
...
var aFunction = __webpack_require__(123);
var anObject = __webpack_require__(112);
var rApply = (__webpack_require__(113).Reflect || {}).apply;
...
var rConstruct = (__webpack_require__(113).Reflect || {}).construct;
...
__webpack_require__(144)('flatMap');
...
__webpack_require__(144)('flatten');
...
__webpack_require__(230)($RegExpStringIterator, 'RegExp String', function next() {
...
__webpack_require__(118) && $export($export.P + __webpack_require__(183), 'Object', {
...
$export($export.G, { global: __webpack_require__(113) });
...
$export($export.S, 'System', { global: __webpack_require__(113) });
...
var metadata = __webpack_require__(142);
var anObject = __webpack_require__(112);
...
var $export = __webpack_require__(21);
var microtask = __webpack_require__(240)();
var process = __webpack_require__(113).process;
var isNode = __webpack_require__(133)(process) == 'process';
...
module.exports = __webpack_require__(135).RegExp.escape;
